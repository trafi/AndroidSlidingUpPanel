...
public class ViewDragHelper {
    ...
    public boolean smoothSlideViewTo(View child, int finalLeft, int finalTop) {
        ...
        return forceSettleCapturedViewAt(finalLeft, finalTop, 0, 0, true);
    }
    ...
    public boolean settleCapturedViewAt(int finalLeft, int finalTop) {
        ...
        return forceSettleCapturedViewAt(finalLeft, finalTop,
                ...
                (int) VelocityTrackerCompat.getYVelocity(mVelocityTracker, mActivePointerId), mIsAutoPeekingEnabled);
    }
     ...
     * @param mIsAutoPeekingEnabled
     * @return true if animation should continue through {@link #continueSettling(boolean)} calls
     */
    private boolean forceSettleCapturedViewAt(int finalLeft, int finalTop, int xvel, int yvel, boolean mIsAutoPeekingEnabled) {
        if (Math.abs(yvel) < mMinVelocity && !mIsAutoPeekingEnabled)
            return false;
